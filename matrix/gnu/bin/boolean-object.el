...
;; NAME PROJECT: guile-missing
;; NAME PROGRAM: boolean-object
;; FUNC PROGRAM: cbs news
;; NEWS NOTICES: cbs news
;; GNU HACKERS: Guile boolean object lisp
;; HELP: manual

;; HAPPEN: friends
;; MATRIX: connect
;; NEXT CONNECTION: friends
;; SUPPORT: friends
;; MODE: style missing
;; METHOD: intel
;; MEMORY: intel
...
;; GNU Guile introduction REPL to edge
;; good view documenation to REPL edge
;; formation units logic to REPL usage
;; utils method uasge.
